    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            jQuery("<?php if($atts['element_custom_class']!='') echo '.'.$atts['element_custom_class'].' ';?> .rit-products-wrap_<?php echo esc_attr($varid); ?> .products-carousel-list").owlCarousel({
                ...
                itemsTablet: [768, <?php if($item>2) { echo esc_js(2); }else{echo 2;} ?>],
...
?>
<div class="wrapper-products-shortcode <?php echo esc_attr($atts['element_custom_class'] . ' ' . $atts['product_style'] . ' ' . $wrappclass) ?>"
