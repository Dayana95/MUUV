...
function ri_everest_scripts() {
    ...
    wp_enqueue_style('RIT_FONT_ICON', get_template_directory_uri() . '/assets/cvfont-icons/cv-fonts-icons.css', array(), false, 'all');
    ...
    if(get_theme_mod('rit_body_font_select', 'google') == 'google' && get_theme_mod('rit_enable_color')) {
        $font_array = array(
            'rit_body_font_google' => json_decode(get_theme_mod('rit_body_font_google'), true),
            'rit_special_font_google' => json_decode(get_theme_mod('rit_special_font_google'), true),
            'rit_title_font_google' => json_decode(get_theme_mod('rit_title_font_google'), true),
        );
        wp_enqueue_style('rit-google-font', create_google_font_url($font_array));
    }
