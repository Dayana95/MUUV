<div class="share-links clearfix">
    <ul class="social-icons">
        ...
        <li class="pinterest"><a href="http://pinterest.com/pin/create/button/?url=<?php the_permalink(); ?>&media=<?php if(function_exists('the_post_thumbnail')) echo wp_get_attachment_url(get_post_thumbnail_id()); ?>&description=<?php echo get_the_title(); ?>"  title="<?php  echo esc_html__('Share to pinterest','ri-everest')?>"><i class="fa fa-pinterest"></i></a></li>
        <li class="mail"><a href="mailto:?subject=<?php the_title(); ?>&body=<?php echo strip_tags(get_the_excerpt()); ?> <?php the_permalink(); ?>" class="product_share_email" title="<?php  echo esc_html__('Sent to mail','ri-everest')?>"><i class="fa fa-mail-forward"></i></a></li>
    </ul>
</div>