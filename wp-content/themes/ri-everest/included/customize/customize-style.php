...
//Font and color
        ...
        $font_family = $body_gg_font['family'];
            $spec_gg_font = json_decode(get_theme_mod('rit_special_font_google', '{"family":"Hind","variants":["300","regular","500","600","700"],"subsets":[]}'),true);
           $spec_font_family = $spec_gg_font['family'];
            $spec_title_gg_font = json_decode(get_theme_mod('rit_title_font_google', '{"family":"Hind","variants":["300","regular","500","600","700"],"subsets":[]}'),true);
