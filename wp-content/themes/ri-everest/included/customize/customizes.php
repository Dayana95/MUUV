            ...
            'rit_product_custom' => array(
                ...
                'settings' => array(
                    ...
                    'rit_product_style' => array(
                        ...
                        'params' => array(
                            'default' => 'product_default_style',
                        ),
                    ),
                    'rit_product_grid_col' => array(
                        'type' => 'select',
                        'label' => esc_html__('Columns', 'ri-everest'),
                        'description' => esc_html__('Number of products display per row in grid layout','ri-everest'),
                        'priority' => 0,
                        'choices' => array(
                            '2' => esc_html__('2 Columns', 'ri-everest'),
                            '3' => esc_html__('3 Columns', 'ri-everest'),
                            '4' => esc_html__('4 Columns', 'ri-everest'),
                            '5' => esc_html__('5 Columns', 'ri-everest'),
                            '6' => esc_html__('6 Columns', 'ri-everest')
                        ),
                        'params' => array(
                            'default' => '3',
                        ),
